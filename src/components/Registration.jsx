...
const Registration = () => {
  ...
  if (!event || !user) return <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center text-white">Carregando...</div>;
      ...
      <div className="max-w-5xl mx-auto p-6 pt-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end border-b border-gray-800 pb-6 mb-10 gap-4">
          ...
          <div className="text-right">
             ...
             <p className="text-xl font-bold">{user.name} <span className="text-[#D80000]">#{user.bike_number || '00'}</span></p>
          </div>
        </div>
